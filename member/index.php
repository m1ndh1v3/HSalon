...
<section class="py-5 fade-in text-center">
  <div class="container">
    ...
    <div class="row justify-content-center g-4">
      ...
      <div class="col-md-4 col-sm-6">
        <a href="../logout.php" class="dashboard-card card text-center shadow-sm text-decoration-none" 
          style="background: #dc3545; color: #fff;">
          <div class="card-body py-4">
            <i class="bi bi-box-arrow-right fs-1 mb-3 icon" style="color:#fff;"></i>
            <h5 class="fw-semibold" style="color:#fff;"><?php echo $lang['logout'] ?? 'Logout'; ?></h5>
          </div>
        </a>
      </div>
